...
public class UtilidadXadesX {
    ...
    /**
     * Obtiene el listado de nodos necesarios para el calculo del sello de tiempo para XAdES X del tipo 1 (implícito) en
     * funcion del esquema XAdES de firma, a partir del nodo SigAndRefs proporcionado, que actúa como tope Los nodos
     ...
     *             Si se produce un error al obtener los nodods
     */
    public static ArrayList<Element> obtenerListadoXADESX1imp(String esquemaXADES, Element firma,
        ...
        if (!(new NombreNodo(esquemaXADES, ConstantesXADES.UNSIGNED_SIGNATURE_PROPERTIES)
            ...
            // El nodo padre de SigAndRefsTimeStamp no es el nodo UnsignedSignatureProperties esperado según el esquema
            // xades
        ...
        if (ConstantesXADES.SCHEMA_XADES_122.equals(esquemaXADES)
                || ConstantesXADES.SCHEMA_XADES_111.equals(esquemaXADES)) { // Búsqueda para los esquemas 1.1.1 y 1.2.2
                                                                            // (coleccion de nodos ordenada)
            ...
            if (ConstantesXADES.SCHEMA_XADES_122.equals(esquemaXADES)) {
                ...
                if ((nodosAttributeCertificateRefs.size() > 1))
                    ...
                    throw new BadFormedSignatureException(
                            I18n.getResource(ConstantesXADES.LIBRERIAXADES_FIRMAXML_ERROR_36) + ConstantesXADES.ESPACIO
                                    + ConstantesXADES.ATTRIBUTE_CERTIFICATE_REFS + ConstantesXADES.ESPACIO
                                    + I18n.getResource(ConstantesXADES.LIBRERIAXADES_FIRMAXML_ERROR_38)
                                    + ConstantesXADES.ESPACIO + nodosAttributeCertificateRefs.size());
                ...
                if ((nodosAttributeRevocationRefs.size() > 1))
                    ...
                    throw new BadFormedSignatureException(
                            I18n.getResource(ConstantesXADES.LIBRERIAXADES_FIRMAXML_ERROR_36) + ConstantesXADES.ESPACIO
                                    + ConstantesXADES.ATTRIBUTE_REVOCATION_REFS + ConstantesXADES.ESPACIO
                                    + I18n.getResource(ConstantesXADES.LIBRERIAXADES_FIRMAXML_ERROR_38)
                                    + ConstantesXADES.ESPACIO + nodosAttributeRevocationRefs.size());
        ...
        if ((listaAparicion[0] != 1) || (listaAparicion[1] < 1) || (listaAparicion[2] != 1) || (listaAparicion[3] != 1)
                || (listaAparicion[4] > 1) || (listaAparicion[5] > 1))
            // La cadena de nodos para el sello de tiempo no es valida
    ...
    /**
     * Obtiene el listado de nodos necesarios para el calculo del sello de tiempo para XAdES X del tipo 2 (explícito) en
    ...
    public static ArrayList<Element> obtenerListadoXADESX2exp(String esquemaXADES, Element firma, Element nodoRefsOnly)
        ...
        if (!(new NombreNodo(esquemaXADES, ConstantesXADES.UNSIGNED_SIGNATURE_PROPERTIES)
                .equals(new NombreNodo(UnsignedSignaturePropertiesElement.getNamespaceURI(),
                        UnsignedSignaturePropertiesElement.getLocalName())))) {
            // El nodo padre de RefsOnlyTimeStamp no es el nodo UnsignedSignatureProperties esperado según el esquema
            // xades
            throw new BadFormedSignatureException(I18n.getResource(ConstantesXADES.LIBRERIAXADES_FIRMAXML_ERROR_40)
        ...
        if (ConstantesXADES.SCHEMA_XADES_132.equals(esquemaXADES)
            ...
            // Se realiza la búsqueda
            ArrayList<Element> nodos = UtilidadTratarNodo.obtenerNodos(UnsignedSignaturePropertiesElement, nodoRefsOnly,
                    nodosABuscar);
        ...
        if ((listaAparicion[0] != 0) || (listaAparicion[1] != 0) || (listaAparicion[2] != 1) || (listaAparicion[3] != 1)
                || (listaAparicion[4] > 1) || (listaAparicion[5] > 1))
            // La cadena de nodos para el sello de tiempo no es valida
            throw new BadFormedSignatureException(I18n.getResource(ConstantesXADES.LIBRERIAXADES_FIRMAXML_ERROR_39));
