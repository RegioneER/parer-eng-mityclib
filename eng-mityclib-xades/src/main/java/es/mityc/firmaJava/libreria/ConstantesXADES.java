...
public interface ConstantesXADES {
    ...
    static final String MSG_NUMERO_FIRMAS_DOCUMENTO = "Numero di firme nel documento: ";

    static final String ERR_CN_NO_TIPO_STRING = "Il CN ottenuto non � di tipoString";
    static final String ERR_CERT_NO_VALUES = "Il certificato non contiene valori";
    ...
    static final String NUMERO_DE_SERIE = "Numero di serie";
    ...
    static final String DEFAULT_LOCALE = "it";
    ...
    static final String MITYC_PROVIDER_V_1_0_IMPLEMENTACION = "MitycProvider v1.0, implementacion de SHA1withRSA basado en KeyStore de Microsoft y OpenOCES - OpenSign";
    ...
    static final String LIBRERIAXADES_VALIDARFIRMA_ERROR174 = "libreriaxades.validarfirmaxml.error174";
    static final String LIBRERIAXADES_VALIDARFIRMA_ERROR175 = "libreriaxades.validarfirmaxml.error175";
    ...
    static final String SCHEMA_XADES_131 = "http://uri.etsi.org/01903/v1.3.1#";
    static final String SCHEMA_XADES_132 = "http://uri.etsi.org/01903/v1.3.2#";
    static final String SCHEMA_XADES_141 = "http://uri.etsi.org/01903/v1.4.1#";
    ...
    static final String LIBRERIAXADES_POLICY_MANAGER_NO_FILE = "No hay fichero de configuracion de policies";
