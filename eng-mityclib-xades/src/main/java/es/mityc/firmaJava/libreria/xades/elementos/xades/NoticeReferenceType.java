...
public class NoticeReferenceType extends AbstractXADESElement {
    ...
    protected void addContent(Element element) throws InvalidInfoNodeException {
        if ((organization == null) || (noticeNumbers == null))
            throw new InvalidInfoNodeException(
                    "Nodo NoticeReferenceType no tiene suficiente informacion");

        element.appendChild(organization.createElement(element.getOwnerDocument(), namespaceXAdES));
        element.appendChild(
                noticeNumbers.createElement(element.getOwnerDocument(), namespaceXAdES));
    }
    ...
    public void load(Element element) throws InvalidInfoNodeException {
        ...
        if ((node == null) || (node.getNodeType() != Node.ELEMENT_NODE))
            throw new InvalidInfoNodeException(
                    "Se esperaba elemento como hijo de NoticeReferenceType");
