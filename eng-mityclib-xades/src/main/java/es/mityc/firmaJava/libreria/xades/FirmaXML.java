...
public class FirmaXML {
    ...
    // Almacena las idÂ´s para el esquema 1.1.1
    ...
    //
    // NodeList listaFirmas = doc.getElementsByTagNameNS(ConstantesXADES.SCHEMA_DSIG,
    ...
    //
    // // Validamos el documento XADES. Como mÃ­nimo serÃ¡ XAdES-BES.
    //
    ...
    // }
    //
    // // Subimos los niveles. EstÃ¡n ordenados de menor a mayor
    ...
    // respuestas.add(bloque);
    // }
    // // Se aÃ±aden los elementos propios de la firma XADES-C
    // // TODO: recuperar el algoritmo de digest de la configuracion para poder configurarlo
    // addXadesC((Element)nodoFirma, respuestas, XAdESSchemas.getXAdESSchema(xadesSchema),
    // UtilidadFirmaElectronica.DIGEST_ALG_SHA1);
    // } else {
