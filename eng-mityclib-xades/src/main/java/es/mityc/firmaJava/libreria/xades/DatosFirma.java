...
public class DatosFirma {
     ...
     * @param esCadenaConfianza .- Booleano que indica si la cadena esta consierada de confianza
     * @param tipoFirma         .- Tipo de firma XAdES (BES, EPES, T...) con dos modificadores para
     *                          EPES y A
     * @param datosSelloTiempo  .- Recoge la informacion de cada sello de tiempo de la firma
     * @param datosCRL          .- Recoge la informacion de cada lista de revocacion de la firma
     * @param datosOCSP         .- Recoge informacion de cada respuesta OCSP de la firma
     * @param fechaFirma        .- Fecha de firma recuperada del nodo SigningTime
     * @param roles             .- roles definidos en la firma
     * @param politicas         .- Recoge informacion de las firmas incluidas en la firma
     * @param esquema           .- Esquema utilizado en la firma
     * @param sigValueId        .- Identificador del nodo que contiene el valor de la firma
     * @param contraFirma.-     ArrayList de String que contiene los identificadores de los nodos
     *                          firmados por ésta firma
     *
     * @parma datosFicherosFirmados .- ArrayList que contiene los datos asociados a los ficheros
     *        firmados
     */
