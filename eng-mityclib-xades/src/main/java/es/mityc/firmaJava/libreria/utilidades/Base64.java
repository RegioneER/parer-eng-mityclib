...
public final class Base64 { // implements ConstantesXADES
    ...
    private static int decode4to3(byte[] source, int srcOffset, byte[] destination, int destOffset, int options) {
        ...
        // Example: DkLE
            ...
            try {
                ...
                System.out.println(ConstantesXADES.CADENA_VACIA + source[srcOffset] + ConstantesXADES.DOS_PUNTOS_ESPACIO
    ...
    public static byte[] decodeFromFile(String filename) {
        ...
        try {
            ...
            // Open a stream
            bis = new Base64.InputStream(new BufferedInputStream(new FileInputStream(file)), ConstantesXADES.DECODE);
    ...
    public static String encodeFromFile(String filename) {
        ...
        try {
            ...
            // Open a stream
            bis = new Base64.InputStream(new BufferedInputStream(new FileInputStream(file)), ConstantesXADES.ENCODE);
