...
public abstract class AbstractXMLElement {
    ...
    /**
     * Devuelve el arbol de nodos que representa este elemento. Implementado por los elementos
     * finales.
     *
     ...
     *
     * @param element elemento del que cuelga la informacion
     *
     * @throws InvalidInfoNodeException lanzada cuando la estructura de nodos leída es invalida
     */
     ...
     *
     * @return <code>true</code> si contienen la misma informacion, <code>false</code> en cualquier
     *         otro caso
     */
