...
public class EncapsulatedCRLValue extends EncapsulatedPKIDataType {
    ...
    public void load(Element element) throws InvalidInfoNodeException {
        ...
        if ((encoding != null) && (!encoding.equals(EncodingEnum.DER_ENCODED)))
            throw new InvalidInfoNodeException("El contenido de EncapsulatedCRLValue debe estar en la codificacion "
        ...
        try {
            ...
            throw new InvalidInfoNodeException("El contenido de EncapsulatedCRLValue no es un certificado X509 valido",
                    ex);
        }
        if (crl == null) {
            throw new InvalidInfoNodeException("El contenido de EncapsulatedCRLValue no es un certificado X509 valido");
