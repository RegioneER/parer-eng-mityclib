...
public class DocumentationReferencesType extends AbstractXADESElement {
    ...
    public DocumentationReferencesType(XAdESSchemas schema,
            ArrayList<DocumentationReference> list) {
        super(schema);
    ...
    public boolean equals(Object obj) {
        if (obj instanceof DocumentationReferencesType) {
            ...
            if (((references == null) || (references.isEmpty()))
                ...
                return true;
            if (((references != null) && (comp != null)) && (references.size() == comp.size())) {
    ...
    protected void addContent(Element element) throws InvalidInfoNodeException {
        if ((references != null) && (references.size() > 0)) {
            ...
            throw new InvalidInfoNodeException(
                    "Nodo DocumentationReferencesType no tiene ningún hijo");
    }
    ...
    public void load(Element element) throws InvalidInfoNodeException {
        ...
        ArrayList<DocumentationReference> temp = new ArrayList<DocumentationReference>(
                nodos.getLength());
        for (int i = 0; i < nodos.getLength(); i++) {
            ...
            if (nodo.getNodeType() != Node.ELEMENT_NODE)
                throw new InvalidInfoNodeException(
                        "Hijo de DocumentationReferencesType no es un elemento");
        ...
        if (temp.size() == 0)
            throw new InvalidInfoNodeException(
                    "DocumentationReferencesType debe tener al menos un hijo");
