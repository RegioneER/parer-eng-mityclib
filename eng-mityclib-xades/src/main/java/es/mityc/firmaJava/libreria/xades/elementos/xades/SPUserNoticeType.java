...
public class SPUserNoticeType extends AbstractXADESElement {
	...
	if (noticeRef != null)
	    element.appendChild(
		    noticeRef.createElement(element.getOwnerDocument(), namespaceXAdES));
	if (explicitText != null)
	    element.appendChild(
		    explicitText.createElement(element.getOwnerDocument(), namespaceXAdES));
    }
	...
	if (node == null)
	    ...
	    throw new InvalidInfoNodeException(
		    "Se esperaba elemento como hijo de SPUserNoticeType");
	...
	if (node != null)
	    throw new InvalidInfoNodeException(
		    "No se esperaba este elemento como hijo de SPUserNoticeType");
    }
