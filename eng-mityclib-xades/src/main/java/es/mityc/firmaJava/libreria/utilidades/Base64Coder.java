 ...
 * 2008-01-15 dse: eliminacion de saltos de carro y espacios en la decodificacion
 */
public final class Base64Coder { // implements ConstantesXADES
	...
	int iLen = in.length;
	if (iLen % 4 != 0)
	    throw new IllegalArgumentException(ConstantesXADES.STR_LENGTH_OF_BASE_64);
	...
	while (ip < iLen) {
		...
		throw new IllegalArgumentException(
			ConstantesXADES.STR_ILLEGAL_CHARACTER_IN_BASE_64);
	    int b0 = map2[i0];
	    int b1 = map2[i1];
	    int b2 = map2[i2];
	    int b3 = map2[i3];
