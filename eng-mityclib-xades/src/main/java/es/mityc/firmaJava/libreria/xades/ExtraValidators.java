 ...
 * <ul>
 * <li>Validacion de política de firma: comprueban que la firma se ajuste a las políticas
 * indicadas.</li>
 * <li>Validacion de certificado: si la firma es valida y no incluye informacion de estado de
 * certificado, comprueba el estado del certificado con este validador.</li>
 * <li>Confianza: comprueban que los elementos de la firma sean de entidades de confianza
 * (certificados de firma, respuestas de estados de certificados, sellos de tiempo, etc).</li>
 * </ul>
 *
