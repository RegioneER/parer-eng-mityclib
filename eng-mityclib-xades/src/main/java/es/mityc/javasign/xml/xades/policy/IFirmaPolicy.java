...
/**
 * Interfaz que han de implementar las clases que añadan policies que gestiona el manager de
 * policies.
 *
...
public interface IFirmaPolicy {
     ...
     *
     * @param signNode       nodo raíz (de firma) de la firma en la que se quiere escribir la
     *                       política
