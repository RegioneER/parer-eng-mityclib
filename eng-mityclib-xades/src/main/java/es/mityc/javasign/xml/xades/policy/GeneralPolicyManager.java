 ...
 * </p>
 * <p>
 * Cuando no se tiene acceso a un validador de políticas se recurre a éste para al menos recuperar
 * informacion sobre la política que se ha aplicado a la firma. Este validador marcara la política
 * como desconocida pero permite obtener informacion y/o documentacion sobre la política.
 * </p>
 *
...
public class GeneralPolicyManager implements IValidacionPolicy {
    ...
    private final static Logger logger = LoggerFactory.getLogger(GeneralPolicyManager.class);
