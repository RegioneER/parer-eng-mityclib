...
/**
 * <p>
 * Gestionado genérico de políticas.
 * </p>
 * <p>
 * Cuando no se tiene acceso a un validador de políticas se recurre a éste para al menos recuperar informacion sobre la
...
public class GeneralPolicyManager implements IValidacionPolicy {
            ...
            if (!signaturePolicyIdentifier.isImplied()) {
                ...
                if (spi.getSigPolicyQualifiers() != null) {
                    ...
                    if ((list != null) && (list.size() > 0)) {
                        MessageDigest md = UtilidadFirmaElectronica
                                .getMessageDigest(spi.getSigPolicyHash().getDigestMethod().getAlgorithm());
    ...
    private DownloadPolicy checkIntegrity(PolicyResult pr, URI uri, SignaturePolicyId spi, URI baseUri,
            MessageDigest md, String digestValue, Document doc) {
                ...
                try {
                    if (org.apache.xml.security.transforms.Transforms.TRANSFORM_C14N_EXCL_OMIT_COMMENTS
                        ...
                        t.addTransform(org.apache.xml.security.transforms.Transforms.TRANSFORM_C14N_WITH_COMMENTS);
                            ...
                            .equals(tr.getAlgorithm())) {
                        t.addTransform(org.apache.xml.security.transforms.Transforms.TRANSFORM_XPATH,
                                tr.getExtraNodes());
                    }
    ...
    private SignaturePolicyIdentifier extractInfo(Element nodoFirma, ResultadoValidacion resultadoValidacion)
        ...
        if (signaturePolicyList.size() != 1)
            throw new PolicyException("Error obteniendo nodo de política (no hay nodo, o hay mas de uno)");
