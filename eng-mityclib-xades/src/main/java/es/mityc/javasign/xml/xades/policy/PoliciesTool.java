...
public class PoliciesTool {
     ...
     *
     * <p>
     * Busca el lugar correspondiente donde debería ir la política en la firma e incluye el nodo con
     * los datos indicados. Si ya existe un nodo de política lo sustituye (solo puede haber una
     * política por firma).
     * </p>
     *
     * @param signNode       Nodo que tiene la firma en la que se quiere insertar el nodo de
     *                       política
     * @param namespaceDS    Namespace del nodo de firma
     * @param namespaceXAdES Namespace de la parte XAdES en la que se insertara la firma
     * @param schema         Version de esquema XAdES
     * @param spi            Nodo de política
     *
     * @throws PolicyException Lanazada cuando no se encuentra donde colocar la política o surge
