...
/**
 * Este interfaz permite la obtencion del hash de informacion para ser firmada que permanece privada
 * a la librería de firma.
 *
...
public interface IPrivateData {
     ...
     *
     * @throws ResourceDataException lanzada cuando no se puede acceder a la informacion por alguna
     *                               razon
     */
