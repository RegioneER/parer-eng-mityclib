...
public interface ICertStatusRecoverer {
     ...
     *
     * @throws CertStatusException Lanzada cuando no se puede recuperar el estado de algún
     *                             certificado
     */
     ...
     * @param cert Certificado que se consulta
     *
     * @return Lista de estados de la cadena de certificacion del certificado consultado. El primer
     *         elemento de la lista sera el estado del propio certificado.
     *
     * @throws CertStatusException Lanzada cuando no se puede recuperar el estado del certificado
     */
     ...
     * @param certs Certificados que se consultan
     *
     * @return Listado con la lista de estados de la cadena de certificacion de cada uno de los
     *         certificados consultados. En cada lista el primer elemento sera el estado del propio
