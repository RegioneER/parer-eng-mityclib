...
public abstract class OCSPResponderID {
	 ...
	 *
	 * @return <code>true</code> si es un responder con el mismo X500Name, <code>false</code> en
	 *         otro caso
	 *
	 ...
	 * @param arg0 Objeto con el que comparar si son el mismo OCSP Responder
	 *
	 * @return <code>true</code> si es un responder con el mismo hash, <code>false</code> en
	 *         otro caso
	 *
	 * @see es.mityc.javasign.certificate.OCSPResponderID#equals(java.lang.Object)
	 */
	...
	public String toString() {
	    return super.toString()
		    + I18N.getLocalMessage(ConstantsAPI.I18N_CERT_5, Arrays.toString(hashPK));
	}
    }
	 ...
	 * <li>OCSPResponderIDHash: convierte la cadena identificativa en binario (suponiéndola
	 * bas64binary) y los compara</li>
	 ...
	 * @param arg0 Objeto con el que comparar si son el mismo OCSP Responder
	 *
	 * @return <code>true</code> si es un responder con la misma identificacion,
