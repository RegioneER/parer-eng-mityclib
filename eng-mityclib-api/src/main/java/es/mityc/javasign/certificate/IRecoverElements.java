...
/**
 * <p>
 * Interfaz que ha de implementar la clase que gestione la recuperacion de elementos relacionados
 * con certificados y sus estados.
 * </p>
 *
 * <p>
 * Se recomienda que los localizadores respondan a los elementos mas comunes de identificacion de
 * elementos:
 * <ul>
 * <li><code>uri</code>: (String)uri donde se encuentra ubicado el elemento (certificado, crl y
 * ocsp)</li>
 * <li><code>issuer.name</code>: (X500Principal) nombre del issuer emisor del elemento (certificado,
 * crl y ocsp)</li>
 ...
 * <li><code>digest.algorithm</code>: (String) nombre del algoritmo de digest aplicado al elemento
 * (crl y ocsp)</li>
...
public interface IRecoverElements {
     ...
     * @param props        Conjunto de propiedades utilizadas para identificar el elemento que se
     *                     quiere recuperar
     ...
     *
     * @throws ElementNotFoundException     lanzada cuando no se encuentra el elemento pedido con
     *                                      los datos provistos
     * @throws UnknownElementClassException lanzada cuando no se reconoce el tipo de dato que hay
