...
/**
 * Interfaz que deben cumplir los decodificadores utilizados en {@link DecoderInputStream} para
 * poder decodificar una entrada al aire (directamente desde el <i>stream</i> de entrada, en
 * pequeños bloques, sin tener que cargar todo el contenido del <i>stream</i>).
 *
...
public interface IDecoder {
     ...
     * @param off  posicion del array desde la que se incluyen los datos
     ...
     *
     * @throws DecodingException lanzada cuando se produce un error decodificando (los datos no se
     *                           ajustan al codec o hay desincronismos en el buffer)
     */
