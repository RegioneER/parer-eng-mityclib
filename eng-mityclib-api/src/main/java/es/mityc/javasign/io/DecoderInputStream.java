...
public class DecoderInputStream extends FilterInputStream {
    ...
    /** Número maximo de intentos de rellenar el buffer con nuevos datos. */
    ...
    /** Flag que indica si el stream de lectura esta cerrado. */
    ...
    /** Mascara para convertir un byte en int. */
    ...
    /**
     * <p>
     * Skips specified number of bytes of decoded data.
     * </p>
     * <p>
