...
/**
 * <p>
 * Implementa un {@link InputStream} equivalente a {@link ByteArrayInputStream} pero que permite
 * escribir en el array del que se alimenta durante su uso.
 * </p>
 *
 * <p>
 * Permite asociar un escritor general para ir llenando el array interno. El escritor general ha de
 * implementar el interfaz {@link IWriter}.
 * </p>
 *
...
public class ByteArrayWrittableInputStream extends InputStream {
    ...
    /**
     * <p>
     * Actualiza los buffers de escritura y lectura con los últimos bytes escritos por el
     * {@link IWriter} asociado.
     * </p>
     *
     ...
     *
     * <p>
     * Comprueba en primer lugar si todavía quedan disponibles bytes en el buffer interno, y si no
     * es el caso, consulta al {@link IWriter} asociado a ver si ya se han producido mas datos.
     * </p>
     *
