 ...
 *
 * <p>
 * En primer lugar busca el fichero de configuracion i18n/i18n.properties que haya por encima en el
 * classpath para la configuracion del comportamiento de la factoría de internacionalizacion. Este
 * fichero ha de cumplir el formato:
 *
 * <pre>
 ...
 * </pre>
 *
 * La clase indicada en la propiedad <code>i18n.factory.class</code> debe tener un método
 * newInstance() estatico que debe devolver un objeto de tipo II18nFactory. Este método sera el
 * consultado para obtener la nueva factoría.
 * </p>
 *
...
public class I18nFactory {
     ...
     *
     * @return Manager con el diccionario indicado. Si se ha dejado la factoría por defecto devuelve
     ...
     * @param specificLocale Locale del que se requiere el diccionario, <code>null</code> si no hay
     *                       Locale preferido
     *
     * @return Manager con el diccionario indicado. Si se ha dejado la factoría por defecto devuelve
     *         un manager del tipo Dumb si no se puede encontrar el diccionario.
     ...
     * ({@link I18nDefaultManager}). Si tiene problemas en la instanciacion del manager configurado
     * devolvera un manager {@link I18nDumbManager}.
     * </p>
     *
     ...
     *
     * @return Manager instanciado e inicializado, I18nDumbManager si ha tenido problemas para
