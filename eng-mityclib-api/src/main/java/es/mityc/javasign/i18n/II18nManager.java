...
public interface II18nManager {
     ...
     *
     * @param dictionary diccionario que debera gestionar el manager
    ...
    /**
     * <p>
     * Devuelve el mensaje identificado por la clave proporcionada según el diccionario gestionado
     * por el manager.
     * </p>
     *
    ...
    /**
     * <p>
     * Devuelve el mensaje compuesto identificado por la clave proporcionada según el diccionario
     * gestionado por el manager.
     * </p>
     *
     * @param message clave que identifica el mensaje
