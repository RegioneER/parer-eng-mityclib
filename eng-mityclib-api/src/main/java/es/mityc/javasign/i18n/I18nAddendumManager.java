 ...
 *
 * <p>
 * Obtiene el diccionario buscando un fichero de propiedades con el mismo nombre que el diccionario
 * la ruta de recursos <code>/i18n/dictionaries</code> y con el tipo de Locale indicado. No se
 * recarga si hay un cambio de Locale.
 * </p>
 * <p>
 * También busca un diccionario con el mismo nombre pero añadiéndole el sufijo <code>_add</code>. En
 * caso de existir buscara las claves en ese fichero antes que en el fichero base.
 * </p>
 *
...
public class I18nAddendumManager extends I18nDefaultManager {
    ...
    /**
     * <p>
     * Busca el diccionario indicado en la ruta <code>i18n/dictionaries</code> siguiendo el nombre
     * del diccionario provisto como un recurso dependiente del locale (@see {@link ResourceBundle})
     * y añadiéndole el sufijo <code>add</code>.
     * </p>
     *
     ...
     * </p>
     * <p>
     * Busca el mensaje en el addenudum en primer lugar. Si no lo encuentra lo busca en el
     * diccionario base.
     * </p>
     *
