...
/**
 * <p>
 * Clase de utilidades para obtener informacion sobre los sistemas operativos/navegadores.
 * </p>
 *
...
public final class OSTool {
    ...
    /** Propiedad de sistema que tiene la version del sistema operativo. */
    ...
    /** Propiedad de sistema que indica la version del plugin que ejecuta la maquina virtual. */
    private static final String JAVAPLUGIN_VERSION = "javaplugin.version";
    /** Propiedad de sistema que tiene el nombre del usuario de la sesion. */
    ...
    /** Variable estatica con el sistema operativo de la actual ejecucion. */
