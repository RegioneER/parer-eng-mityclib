 ...
 *
 * <p>
 * Mediante esta factoría, bajo patron singleton, se instancia los facades que dan servicio de
 * firma. Estos facades deberan contar con un constructor sin parametros que sera el llamado para
 * generar la instancia que se entregara.
 * </p>
 * <p>
 * Los facades a instanciar se configuran mediante un fichero de propiedades
 * (<code>bridge/sign.properties</code>), a través de su propiedad <code>facade.sign.class</code> en
 * la cual se indica la clase facade:
 *
 * <pre>
...
public final class SignFactory {
    /** Logger. */
    private static final Logger LOG = LoggerFactory.getLogger(SignFactory.class);
    /** Internacionalizador. */
