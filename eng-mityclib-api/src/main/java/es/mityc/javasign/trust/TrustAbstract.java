...
public abstract class TrustAbstract {
     ...
     *
     * @throws TrustException lanzada cuando el objeto no es de confianza o ha ocurrido algún error
     *                        al intentar comprobarlo:
     *                        <ul>
     *                        <li>{@link UnknownTrustException} lanzada cuando se desconoce si el
     *                        objeto es o no de confianza (el objeto es desconocido o no se puede
     *                        comprobar su confianza).</li>
     *                        <li>{@link NotTrustedException} lanzada cuando el objeto no es de
     *                        confianza.</li>
     *                        </ul>
     */
     ...
     *
     * @throws UnknownTrustException Si no se dispone de la ruta de certificacion
     */
