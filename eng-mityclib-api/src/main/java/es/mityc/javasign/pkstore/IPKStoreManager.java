...
/**
 * <p>
 * Interfaz para la manipulacion de claves públicas/privadas y certificados en un ambiente de firma
 * digital.
 * </p>
 *
...
public interface IPKStoreManager {
    ...
    /**
     * <p>
     * Provider que permite el acceso a funciones criptograficas relacionadas con los certificados
     * (PK) disponibles en el almacén.
     * </p>
     *
    ...
    /**
     * <p>
     * Obtiene un listado de los certificados de las entidades de confianza disponibles en el
     * almacén.
     * </p>
     *
     * @return los certificados como un listado de X509Certificate
     ...
     *
     * @throws CertStoreException si hay algún problema en el acceso al almacén de certificados o el
     *                            almacén no contiene el certificado indicado
     */
     ...
     *
     * @throws CertStoreException si hay algún problema en el acceso al almacén de certificados o no
     *                            hay clave privada asociada
     */
