 ...
 * </p>
 * <p>
 * Mediante la implementacion de este interfaz se obtiene acceso a la manipulacion de los
 * certificados disponibles en el almacén de certificados.
 * </p>
 *
...
public interface IPKStoreMaintainer {
     ...
     * </p>
     * <p>
     * Si el certificado que se intenta eliminar no es un certificado de confianza, sino de firma,
     * no se debera eliminar.
     * </p>
     *
     ...
     * @param cert     Certificado asociado a la clave pública relacionada con la clave privada
     *                 importada
     * @param password Contraseña que se aplicara a la clave privada en el almacén
     *
     * @throws CertStoreException lanzada si hay algún problema en la importacion de la clave
    ...
    /**
     * <p>
     * Elimina un certificado del almacén de certificados que esté asociado a una clave privada,
     * junto con la clave privada.
     * </p>
     *
     * @param cert Certificado asociado a una clave privada a eliminar
     *
     * @throws CertStoreException lanzada si hay algún problema en la eliminacion del certificado y
     *                            de la clave privada
     */
     ...
     *
     * @throws CertStoreException lanzada si hay algún problema en la actualizacion del certificado
     */
