...
/**
 * <p>
 * Proporciona un mecanismo por defecto para mostrar una ventana que pida al usuario la contraseña
 * de acceso a un certificado ubicado en un dispositivo seguro.
 * </p>
 *
...
public class DefaultPassStoreKS implements IPassStoreKS {
    ...
    /**
     * <p>
     * Muestra una ventana de dialogo para que el usuario introduzca una contraseña de acceso a un
     ...
     * </p>
     * <p>
     * Este método se mantiene para facilitar la gestion de hijos sobre la informacion a mostrar.
     * Sobreescribiéndolo se puede preparar un dialogo adecuado al caso.
     * </p>
     *
     ...
     * <p>
     * Este método se mantiene para facilitar la gestion de hijos sobre la informacion a mostrar.
     * Sobreescribiéndolo se puede preparar un título de ventana relacionado con los datos
     * provistos.
     * </p>
     *
