...
public final class Base64 {
     ...
     * silly, to specify ConstantesTSA.ORDERED and ConstantesTSA.URL_SAFE in which case one of them will be picked,
    ...
    private static int decode4to3(byte[] source, int srcOffset, byte[] destination, int destOffset, int options) {
        ...
        // Example: DkLE
            ...
            try {
                ...
                System.out.println(ConstantesTSA.CADENA_VACIA + source[srcOffset] + ConstantesTSA.DOS_PUNTOS_ESPACIO
                        + (DECODABET[source[srcOffset]]));
                System.out.println(ConstantesTSA.CADENA_VACIA + source[srcOffset + 1] + ConstantesTSA.DOS_PUNTOS_ESPACIO
                        + (DECODABET[source[srcOffset + 1]]));
                System.out.println(ConstantesTSA.CADENA_VACIA + source[srcOffset + 2] + ConstantesTSA.DOS_PUNTOS_ESPACIO
                        + (DECODABET[source[srcOffset + 2]]));
                System.out.println(ConstantesTSA.CADENA_VACIA + source[srcOffset + 3] + ConstantesTSA.DOS_PUNTOS_ESPACIO
     ...
     *            the string to decode
     * @param options
     *            encode options such as ConstantesTSA.URL_SAFE
     * 
     * @return the decoded data
     * 
     * @since 1.4
    ...
    public static byte[] decodeFromFile(String filename) {
        ...
        try {
            ...
            // Open a stream
            bis = new Base64.InputStream(new BufferedInputStream(new FileInputStream(file)), ConstantesTSA.DECODE);
    ...
    public static String encodeFromFile(String filename) {
        ...
        try {
            ...
            // Open a stream
            bis = new Base64.InputStream(new BufferedInputStream(new FileInputStream(file)), ConstantesTSA.ENCODE);
    ...
    public static class InputStream extends FilterInputStream {
        ...
        public InputStream(java.io.InputStream in, int options) {
            super(in);
            this.breakLines = (options & ConstantesTSA.DONT_BREAK_LINES) != ConstantesTSA.DONT_BREAK_LINES;
