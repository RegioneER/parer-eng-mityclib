 ...
 * Public License Version 2 or later (the "LGPL"), in which case the provisions of the LGPL are
 * applicable instead of those above. See terms of LGPL at <http://www.gnu.org/copyleft/lesser.txt>.
 * If you wish to allow use of your version of this file only under the terms of the LGPL and not to
 * allow others to use your version of this file under the Apache Software License, indicate your
 * decision by deleting the provisions above and replace them with the notice and other provisions
 * required by the LGPL. If you do not delete the provisions above, a recipient may use your version
 ...
 *         </p>
 *         <p>
 *         This class has been adapted to works in MITyCLibTSA.
 *         </p>
 */
public class OwnSSLProtocolSocketFactory implements SecureProtocolSocketFactory {

    /** Log object for this class. */
    private static final Logger LOG = LoggerFactory.getLogger(OwnSSLProtocolSocketFactory.class);
     ...
     *
     * @param ssl Gestionador de la autenticacion y confianza de la comunicacion SSL
     *
     *            Code sample:
     *
     *            <blockquote> Protocol stricthttps = new Protocol( "https", new
     *            OwnSSLProtocolSocketFactory(true), 443);
     *
    ...
    /**
     * Parses a X.500 distinguished name for the value of the "Common Name" field. This is done a
     * bit sloppy right now and should probably be done a bit more according to
     * <code>RFC 2253</code>.
     *
